...
| :---------- | ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **Linux**   | [Download `repomatic-6.2.0-linux-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.0/repomatic-6.2.0-linux-arm64.bin)     | [Download `repomatic-6.2.0-linux-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.0/repomatic-6.2.0-linux-x64.bin)     |
| **macOS**   | [Download `repomatic-6.2.0-macos-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.0/repomatic-6.2.0-macos-arm64.bin)     | [Download `repomatic-6.2.0-macos-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.0/repomatic-6.2.0-macos-x64.bin)     |
| **Windows** | [Download `repomatic-6.2.0-windows-arm64.exe`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.0/repomatic-6.2.0-windows-arm64.exe) | [Download `repomatic-6.2.0-windows-x64.exe`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.0/repomatic-6.2.0-windows-x64.exe) |

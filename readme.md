...
| :---------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **Linux**   | [Download `repomatic-6.2.1-linux-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.1/repomatic-6.2.1-linux-arm64.bin)     | [Download `repomatic-6.2.1-linux-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.1/repomatic-6.2.1-linux-x64.bin)     |
| **macOS**   | [Download `repomatic-6.2.1-macos-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.1/repomatic-6.2.1-macos-arm64.bin)     | [Download `repomatic-6.2.1-macos-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.1/repomatic-6.2.1-macos-x64.bin)     |
| **Windows** | [Download `repomatic-6.2.1-windows-arm64.exe`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.1/repomatic-6.2.1-windows-arm64.exe) | [Download `repomatic-6.2.1-windows-x64.exe`](https://github.com/kdeldycke/repomatic/releases/download/v6.2.1/repomatic-6.2.1-windows-x64.exe) |
...
Running `uvx -- repomatic init --overwrite` in an existing downstream repository handles the migration automatically:

- Regenerates workflow files to reference `kdeldycke/repomatic`.
- Renames `[tool.gha-utils]` (or `[tool.repokit]`) to `[tool.repomatic]` in `pyproject.toml`.
- Removes old `.claude/skills/gha-*/` skill directories.

After that, two things require manual attention:

1. **Update CLI references**. Replace `gha-utils` / `uvx gha-utils` with `repomatic` / `uvx repomatic` in any scripts, Makefiles, or CI steps outside of the managed workflow files.

2. **Review `tests.yaml`**. This is the only non-reusable workflow — it contains project-specific logic. If it references `kdeldycke/workflows` or `gha-utils` in comments or `uses:` lines, update those manually.
...
# 1. Regenerate all files and auto-migrate legacy config and skills.

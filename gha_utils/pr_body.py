...
files in ``gha_utils/templates/``, optionally with YAML frontmatter for
...
def load_template(name: str) -> tuple[dict[str, object], str]:
    """Load a PR body template from the ``gha_utils/templates/`` package.
    ...
    """
    template_files = files("gha_utils.templates")
...
def get_template_names() -> list[str]:
    ...
    """
    template_dir = files("gha_utils.templates")
    names = []

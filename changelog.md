...
- Rename `WORKFLOW_UPDATE_GITHUB_PAT` secret to `REPOMATIC_PAT`. Workflows accept both names for backward compatibility; downstream repos can migrate at their own pace.

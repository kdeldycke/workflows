...
Downstream repositories consuming reusable workflows from ``kdeldycke/repokit``
...
DEFAULT_REPO: Final[str] = "kdeldycke/repokit"
...
For release builds (e.g., ``repokit==5.11.0``), this resolves to the
...
def generate_thin_caller(
    ...
    :param repo: Upstream repository (default: ``kdeldycke/repokit``).

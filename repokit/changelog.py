...
.. note::
    ...
    (see `issue #94
    <https://github.com/kdeldycke/repokit/issues/94>`_) — none
...
class Changelog:
    ...
    def update(self) -> str:
        ...
        ## [2.17.5 (unreleased)](https://github.com/kdeldycke/repokit/compare/v2.17.4...main)
        ...
        *** 1,6 ****
        ...
        ! ## [2.17.6 (unreleased)](https://github.com/kdeldycke/repokit/compare/v2.17.4...main)

...
Regenerates the Mermaid dependency graph from the `uv` lockfile. See the [`update-deps-graph` job documentation](https://github.com/kdeldycke/repokit?tab=readme-ov-file#githubworkflowsautofixyaml-jobs) for details.

...
``repokit/data/`` and orchestrates repository bootstrapping via
``repokit init``.

Available components (``repokit init <component>``):
...
DEFAULT_REPO: str = "kdeldycke/repokit"
...
class InitConfig:
    ...
    filename: str
    """Filename in repokit/data/ directory."""
...
EXPORTABLE_FILES: dict[str, str | None] = {
    ...
    "skill-repokit-deps.md": "./.claude/skills/repokit-deps/SKILL.md",
    "skill-repokit-init.md": "./.claude/skills/repokit-init/SKILL.md",
    "skill-repokit-lint.md": "./.claude/skills/repokit-lint/SKILL.md",
    "skill-repokit-metadata.md": "./.claude/skills/repokit-metadata/SKILL.md",
    "skill-repokit-release.md": "./.claude/skills/repokit-release/SKILL.md",
    "skill-repokit-sync.md": "./.claude/skills/repokit-sync/SKILL.md",
    "skill-repokit-test.md": "./.claude/skills/repokit-test/SKILL.md",
    # Workflow templates.
...
def get_data_content(filename: str) -> str:
    ...
    This is the low-level function for reading any file from ``repokit/data/``.

    :param filename: Name of the file to retrieve (e.g., "labels.toml").
    :return: Content of the file as a string.
    :raises FileNotFoundError: If the file doesn't exist.
    """
    data_files = files("repokit.data")
...
def _get_renovate_config() -> str:
    ...
    in ``repokit/data/renovate.json5``.
...
def run_init(
    ...
    """Bootstrap a repository for use with ``kdeldycke/repokit``.
    ...
    # Fetch extra label files from [tool.repokit] config.
...
def _fetch_extra_labels(
    ...
    """Download extra label files from ``[tool.repokit]`` config.
    ...
    from .metadata import load_repokit_config

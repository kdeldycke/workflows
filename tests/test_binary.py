...
class TestBinaryArchMappings:
    """Tests for BINARY_ARCH_MAPPINGS constant."""
    ...
    def test_all_targets_present(self, target):
    ...
    def test_mapping_values(self, target, expected_field, expected_substring):
...
class TestVerifyBinaryArch:
    """Tests for verify_binary_arch function."""
    ...
    def test_matching_arch(self, tmp_path, target, field, value):
    ...
    def test_mismatched_arch(self, tmp_path, target, field, wrong_value):
...
class TestExtractBinaryNames:
    """Tests for extract_binary_names function."""
    ...
    def test_missing_include_key(self):
...
class TestCollectAndRenameArtifacts:
    """Tests for collect_and_rename_artifacts function."""
    ...
    def test_non_binary_artifacts(self, tmp_path):
    ...
    def test_binary_rename(self, tmp_path):
    ...
    def test_mixed_artifacts(self, tmp_path):
...
class TestFormatGithubOutput:
    """Tests for format_github_output function."""

...
from repokit.cli import remove_header
from repokit.mailmap import Mailmap, Record


def test_remove_header():
    content = dedent("""\
        # Generated by repokit sync-mailmap v4.4.3 - https://github.com/kdeldycke/repokit
...
def test_new_entry():
    ...
    header = dedent(
        """\
        # Generated by repokit sync-mailmap v4.16.2 - https://github.com/kdeldycke/repokit

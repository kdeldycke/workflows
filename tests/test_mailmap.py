...
def test_remove_header():
    content = dedent("""\
        # Generated by gha-utils sync-mailmap v4.4.3 - https://github.com/kdeldycke/workflows
...
def test_new_entry():
    ...
    header = dedent(
        """\
        # Generated by gha-utils sync-mailmap v4.16.2 - https://github.com/kdeldycke/workflows

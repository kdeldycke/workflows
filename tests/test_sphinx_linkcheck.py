...
class TestFilterBroken:
    """Tests for filter_broken."""
...
class TestGenerateMarkdownReport:
    ...
    def test_groups_by_file_alphabetically(self):
    ...
    def test_escapes_pipe_chars_in_info(self):
